...
@section('title')
    Where We Work | Borno Women Development Initiative (BOWDI)
@endsection
        ...
        <div class="lg:grid grid-cols-3 gap-8 mt-10 md:px-24 px-8">
            <div class="text-justify col-span-2 border-r pr-4 border-green-400">
                ...
                <div>
                    ...
                    <p class="mb-5 border-l-4 pl-5 border-green-400">
            ...
            <div class="text-left col-span-1">
                <div class="mb-5">
                    <div>
                        <h1 class="text-xl font-bold mb-4">Core values</h1>
                    </div>
                    <div>
                        <p class="mb-2">Accountability</p>
                        <p class="mb-2">Transparency</p>
                        <p class="mb-2">Professionalism</p>
                        <p class="mb-2">Diversity</p>
                        <p class="mb-2">Integrity</p>
                        <p class="mb-2">Constructive Engagement</p>
                        <p class="mb-2">Collaboration</p>
                    </div>
                </div>
                <div class="mb-5">
                    <div>
                        <h1 class="text-xl font-bold mb-4">Objectives</h1>
                    </div>
                    <div>
                        <p class="mb-2">To educate children thereby preventing them from being part of terror activities and molding their future</p>
                        <p class="mb-2">To build healthy society of strong, educated and independent women</p>
                        <p class="mb-2">To partner with gov't and Organizations in providing access to education for children</p>
                        <p class="mb-2">To train girls and women on various productive hand work and providing them with various materials and capital</p>
                        <p class="mb-2">To organize workshops, seminars and talking sessions to expose them into the social world, creating conducive atmosphere for development</p>
                        <p class="mb-2">To enlighten teenage girls about personal health, first aid and SGBV in their immediate environment</p>
                    </div>
                </div>
                <div class="mb-5">
                    <div>
                        <h1 class="text-xl font-bold mb-4">Working Approach</h1>
                    </div>
                    <div>
                        <p class="mb-2 text-justify">The organization is committed to encourage active participation of the communities in the development of social and economic aspects of the society through their involvement in planning, decision making and implementation of activities. The planned or undertaken programs by the organization keep the aspects of sustainability, gender, social harmony and accountability at the forefront</p>
                    </div>
                </div>
            </div>
        </div>
