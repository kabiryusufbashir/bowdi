...
@section('body-content')
    <!-- Founder  -->
    <div class="bg-white">
        <div class="mt-10 md:px-24 px-8 pb-10">
            <div class="text-center mx-auto lg:w-1/2 w-full">
                <div>
