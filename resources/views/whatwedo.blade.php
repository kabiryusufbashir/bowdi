...
@section('title')
    What We Do | Borno Women Development Initiative (BOWDI)
@endsection

@section('page-meta')
    <meta name="description" content="The purpose of Livelihood Assistance Program is to revive the spirit of self reliance and to alleviate poverty through increasing the income and asset creation among the most affected population through a process that best defines the need of the community called Community Based Participatory Planning(CBPP)">
...
@section('body-content')
    <!-- What We Do  -->
    <div class="bg-white">
        <div class="mt-10 md:px-24 px-8">
            <div class="text-center pb-10">
                <div>
                    <h1 class="text-3xl font-bold mb-4 text-center">Our Services</h1>
                </div>
                <div class="lg:grid grid-cols-3 gap-4 mt-10">
                    <div class="mb-5 lg:px-14 px-8">
                        <div class="mb-2">
                            <i class="fa-solid fa-house text-6xl text-green-600"></i>
                        </div>
                        <div class="mb-4">
                    ...
                    <div class="mb-5 lg:px-14 px-8">
                        ...
                        <div class="text-justify">
                            ...
                            <p>
                                UNHCR then went ahead to implement thesame project in Pulka, Bama and Damasak
                            </p>
                        </div>
                    </div>
                    <div class="mb-5 lg:px-14 px-8">
                        <div class="mb-2">
                            <i class="fa-solid fa-school text-6xl text-green-600"></i>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="text-justify">
                            ...
                            <p>
                                In 2018, another Non Formal Learning center was formed as a result of the success in the first project. International Rescue Committee (IRC) also enrolled 850 children with 70% girls to thesame Non Formal Learning Center with more success to the previous project, 98% of the population graduated as the 2% left the community as they were mostly IDPs. IRC is now working on formally enrollling the children to formal schools
                            </p>
                        </div>
                    </div>
                </div>
